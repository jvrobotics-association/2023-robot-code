...
public class Drivetrain extends SubsystemBase {
    ...
    private final SwerveDriveKinematics kDriveKinematics =
        new SwerveDriveKinematics(new Translation2d(l, w),
            new Translation2d(l, -w),
            new Translation2d(-l, w),
            new Translation2d(-l, -w));

    private final SwerveModulePosition[] swerveModulePositions = {new SwerveModulePosition(r, new Rotation2d(l, w)),
...
//    SmartDashboard.putString("m_rearRight", m_rearRight.getState().toString());
    ...
    public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, Translation2d rotationOffset) {
